...
export function AssistantWorkflowModal({
  ...
  const builtins = useMemo(() => BUILT_IN_WORKFLOWS.filter((w) => w.type === "assistant"), []);
    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/10 backdrop-blur-xs">
      ...
      >
        ...
        <div className="flex flex-row flex-1 min-h-0 overflow-hidden">
          ...
          {selected && (
            <div
              className={`flex-1 border-l border-gray-100 flex flex-col overflow-hidden px-3 pb-3 transition-opacity duration-200 ${rightVisible ? "opacity-100" : "opacity-0"}`}
            >
