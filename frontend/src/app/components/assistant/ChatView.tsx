...
import type { MikeCitationAnnotation, MikeEditAnnotation, MikeMessage } from "../shared/types";
  ...
  return (
    <div className="h-full w-full flex relative">
      ...
      <div className="flex flex-col h-full flex-1 relative">
                  ...
                  <div key={i} ref={i === lastUserIndex ? latestUserMessageRef : null}>
                    {msg.role === "user" ? (
                      ...
                      <AssistantMessage
                        ...
                        isError={!!msg.error}
                        errorMessage={typeof msg.error === "string" ? msg.error : undefined}
        ...
        {/* Chat input */}
        <div ref={chatInputRef} className="absolute bottom-0 left-0 right-0 w-full z-30">
