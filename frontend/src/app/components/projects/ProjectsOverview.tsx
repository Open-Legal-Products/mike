  ...
  return (
    <div className="flex-1 overflow-y-auto bg-white">
      ...
      <div className="mb-1 flex items-center justify-between px-4 py-3 md:px-10">
        <h1 className="text-2xl font-medium font-serif text-gray-900">Projects</h1>
        ...
        <div className="min-w-max">
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-start py-24 w-full max-w-xs mx-auto">
              ...
              <p className="text-2xl font-medium font-serif text-gray-900">Projects</p>
              <p className="mt-1 text-xs text-red-500 max-w-xs">{loadError}</p>
            </div>
          ) : filtered.length === 0 ? (
            <div className="flex flex-col items-start py-24 w-full max-w-xs mx-auto">
                  ...
                  >
                    ...
                    >
                      {renamingId === project.id ? (
                        ...
                        <span className="text-sm text-gray-800 truncate block">{project.name}</span>
                      )}
                    </div>
