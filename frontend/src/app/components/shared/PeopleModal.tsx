...
export function PeopleModal({
  ...
  const isSelfEmail =
    !!normalizedCurrentUserEmail && trimmedNewEmail === normalizedCurrentUserEmail;
  const canAdd = isValidEmail && !alreadyShared && !isOwnerEmail && !isSelfEmail && busy === null;
        ...
        {onSharedWithChange && (
          <div className="px-4 pt-1 pb-2">
            ...
            {isSelfEmail && !isOwnerEmail && trimmedNewEmail && (
              <p className="mt-1.5 text-xs text-gray-400">You cannot share this with yourself.</p>
            )}
            {trimmedNewEmail &&
              !isValidEmail &&
              !alreadyShared &&
              !isOwnerEmail &&
              !isSelfEmail && <p className="mt-1.5 text-xs text-gray-400">Enter a valid email.</p>}
