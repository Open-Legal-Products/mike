...
export function AppSidebar({ isOpen, onToggle }: AppSidebarProps) {
  ...
  const { chats, currentChatId, hasMoreChats, loadMoreChats, setCurrentChatId } =
  ...
  const [recentProjects, setRecentProjects] = useState<MikeProject[] | null>(null);
              ...
              {isOpen && (
                ...
                >
                  <div className="flex flex-col gap-0.5 min-w-0">
                    ...
                    <div className="text-[12px] text-gray-500 leading-none">{getUserTier()}</div>
                  </div>
