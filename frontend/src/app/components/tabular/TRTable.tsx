...
export const TRTable = forwardRef<TRTableHandle, Props>(function TRTable(
  ...
  if (columns.length === 0 && documents.length === 0 && uploadingFilenames.length === 0) {
    return (
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="relative flex min-h-0 flex-1">
          ...
          <div className="flex flex-1 flex-col items-start justify-center w-full max-w-xs mx-auto">
            ...
            <p className="text-2xl font-medium font-serif text-gray-900">Tabular Review</p>
  ...
  return (
    <div className="flex flex-1 flex-col overflow-auto" ref={scrollContainerRef}>
      {/* Header */}
      <div className="sticky top-0 z-20 flex bg-white h-8" style={{ minWidth: totalContentWidth }}>
        <div
      ...
      <div className="relative min-h-0 flex-1">
        ...
        {uploadingFilenames.map((filename) => (
          ...
          >
            ...
            {sortedColumns.map((col) => (
              <div key={col.index} className={`${COL_W} border-b border-r border-gray-200 p-2`}>
        ...
        {documents.map((doc, docIdx) => {
          const baseRowBg = docIdx % 2 === 0 ? "bg-white" : "bg-gray-50";
          const rowBg = selectedDocIds.includes(doc.id) ? "bg-gray-100" : baseRowBg;
          return (
