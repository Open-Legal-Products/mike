...
import { Plus, Library, Table2, MessageSquare, User, ChevronDown, Check } from "lucide-react";
...
export function WorkflowList() {
  ...
  const [typeFilter, setTypeFilter] = useState<MikeWorkflow["type"] | null>(null);
            ...
            <div className="flex flex-col items-start py-24 w-full max-w-xs mx-auto">
              {activeTab === "custom" ? (
                <>
                  ...
                  <p className="text-2xl font-medium font-serif text-gray-900">Custom Workflows</p>
                ...
                <>
                  <Library className="h-8 w-8 text-gray-300 mb-4" />
                  <p className="text-2xl font-medium font-serif text-gray-900">Hidden Workflows</p>
                  <p className="mt-1 text-xs text-gray-400 text-left">
            ...
            filtered.map((wf) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="text-sm text-gray-800 truncate block">{wf.title}</span>
                  </div>
