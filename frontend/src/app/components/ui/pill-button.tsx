...
const toneClasses: Record<PillButtonTone, string> = {
    ...
    white: "border-transparent bg-white text-gray-700 shadow-[0_1px_3px_rgba(15,23,42,0.08),inset_1px_1px_0_rgba(255,255,255,0.82),inset_-1px_-1px_0_rgba(255,255,255,0.5)] hover:bg-gray-100 disabled:hover:bg-white",
