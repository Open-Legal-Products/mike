...
describe("thin endpoint wrappers", () => {
    ...
    const cases: WrapperCase[] = [
        ...
        // Organizations (multi-tenant RBAC)
        {
            ...
            call: () =>
                createProject("Firm matter", undefined, undefined, undefined, "org-1"),
            url: "/projects",
            method: "POST",
        ...
        {
            // role defaults to "member" when the caller does not pick one.
            name: "addOrgMember (default role)",
            call: () => addOrgMember("org-1", "colleague@firm.example"),
            url: "/orgs/org-1/members",
            method: "POST",
            body: { email: "colleague@firm.example", role: "member" },
        },
        {
            name: "addOrgMember (explicit admin)",
            call: () => addOrgMember("org-1", "partner@firm.example", "admin"),
            url: "/orgs/org-1/members",
            method: "POST",
            body: { email: "partner@firm.example", role: "admin" },
        },
        {
        ...
        {
            name: "listOrgTeams",
            call: () => listOrgTeams("org-1"),
            url: "/orgs/org-1/teams",
        },
        {
            name: "createOrgTeam",
            call: () => createOrgTeam("org-1", "Litigation"),
            url: "/orgs/org-1/teams",
            method: "POST",
            body: { name: "Litigation" },
        },
        {
            name: "deleteOrgTeam",
            call: () => deleteOrgTeam("org-1", "team-1"),
            url: "/orgs/org-1/teams/team-1",
            method: "DELETE",
        },
        {
            name: "addOrgTeamMember",
            call: () => addOrgTeamMember("org-1", "team-1", "colleague@firm.example"),
            url: "/orgs/org-1/teams/team-1/members",
            method: "POST",
            body: { email: "colleague@firm.example" },
        },
        {
            name: "removeOrgTeamMember",
            call: () => removeOrgTeamMember("org-1", "team-1", "user-2"),
            url: "/orgs/org-1/teams/team-1/members/user-2",
            method: "DELETE",
        },
    ];
