    ...
    return (
      <div className="h-full flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-xl text-center">
          ...
          <p className="text-gray-600 mb-6">We will get in touch with you soon via email.</p>
          <button
            onClick={() => router.push("/")}
    ...
    <div className="w-full flex flex-col px-6 h-full">
      <div className="w-full max-w-4xl m-auto flex flex-col h-full">
        ...
        <div className="flex-shrink-0 pt-6 md:pt-10 pb-0">
          <div className="mb-5">
            <h1 className="text-4xl font-medium font-eb-garamond text-gray-900 mb-3">Support</h1>
          </div>
        </div>
                    ...
                    >
                      <div
                        className={`font-medium ${
                          feedbackType === type.value ? "text-blue-700" : "text-gray-900"
                        }`}
                      >
                        {type.label}
                      </div>
              ...
              {feedbackType === "bug" && (
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    If the bug is in a chat, mouseover the chat in the sidebar, click the dots, then
                    click share and paste the link here.
                  </p>
                </div>
              )}
