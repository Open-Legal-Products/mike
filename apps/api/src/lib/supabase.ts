...
export type MikeSupabaseClient = any;

let _adminClient: MikeSupabaseClient | undefined;

export function getAdminClient(): MikeSupabaseClient {
  if (!_adminClient) {
...
/** @deprecated Use getAdminClient() directly. */
export function createServerSupabase(): MikeSupabaseClient {
