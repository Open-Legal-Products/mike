...
/**
 * All state + handlers for ProjectDocumentsView. Extracted so the view file is
 * a pure presenter: this hook owns the document/folder/version state machine
 * (uploads, version history, drag-and-drop moves, optimistic delete) and
 * returns a flat bag of values + callbacks the JSX renders. Behaviour is
 * unchanged from when this lived inline in the component.
 */
