        ...
        const maxRows = await db
            ...
            .where(
                and(
                    ...
                    inArray(document_versions.source, [
                        "upload",
                        "user_upload",
                        "assistant_edit",
                    ]),
                ...
                try {
                    ...
                    if (!raw) {
                        ...
                        if (
                            ...
                            fail(
                                `Failed to record replicated documents: ${docInsertError ?? "unknown"}`,
                            );
                        } else {
