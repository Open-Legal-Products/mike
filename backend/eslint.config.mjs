...
export default [
    ...
    // Baseline JS hygiene as WARNINGS only: the blocking (error) tier is
    // reserved for the security rules below that fire solely on genuinely
    // unsafe APIs. Enabling recommended at its default error level would put
    // ~30 general-purpose rules in the blocking tier.
    {
        rules: Object.fromEntries(
            Object.entries(js.configs.recommended.rules ?? {}).map(
