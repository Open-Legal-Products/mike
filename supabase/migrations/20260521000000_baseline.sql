-- Baseline migration — captures the full schema as of 2026-05-21.
-- DO NOT edit this file. All future schema changes go in new numbered migration files.
--
-- Bootstrap instructions for an existing production database:
--   Run this file against a fresh DB, OR mark it as already applied on prod with:
--     INSERT INTO supabase_migrations.schema_migrations (version, name, statements)
--     VALUES ('20260521000000', 'baseline', ARRAY['-- baseline stamped manually']);
--   This prevents the CLI from re-applying the baseline to a database that already
--   has this schema in place.
