...
module.exports = async (_env, options) => {
  ...
  const config = {
    ...
    resolve: {
      ...
      alias: {
        // Shared design system (the @mike/shared package) lives one level up,
        // outside the add-in root. Same name the web app imports.
        "@mike/shared": path.resolve(__dirname, "../shared"),
