...
const QUICK_ACTIONS = [
  {
    label: "Proofread",
    prompt: "Proofread the current document and suggest tracked corrections.",
  },
  {
    label: "Compare documents",
    prompt:
      "Compare the current document with the documents I attach and summarize the material differences.",
  },
  {
    label: "Extract key terms",
    prompt: "Extract and summarize the key terms in the current document.",
  },
  {
    label: "Draft from template",
    prompt:
      "Draft a new document using the template I attach and the current document as context.",
  },
] as const;
